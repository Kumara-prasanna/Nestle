CREATE TABLE [dbo].[CD_TEST_ADVERITY] (
...
GO
CREATE NONCLUSTERED INDEX [ix_CD_TEST_ADVERITY_dt_filename]
    ON [dbo].[CD_TEST_ADVERITY]([dt_filename] ASC);


GO
CREATE TRIGGER [dbo].[CD_TEST_ADVERITY_dss_update_trigger] ON [dbo].[CD_TEST_ADVERITY] FOR UPDATE AS
SET NOCOUNT ON
...
GO
CREATE TRIGGER [dbo].[CD_TEST_ADVERITY_dss_insert_trigger] ON [dbo].[CD_TEST_ADVERITY] FOR INSERT AS
SET NOCOUNT ON
DECLARE @marker_create_scope_local_id INT
DECLARE @marker_scope_create_peer_timestamp BIGINT
DECLARE @marker_scope_create_peer_key INT
...
GO
CREATE TRIGGER [dbo].[CD_TEST_ADVERITY_dss_delete_trigger] ON [dbo].[CD_TEST_ADVERITY] FOR DELETE AS
SET NOCOUNT ON
DECLARE @marker_create_scope_local_id INT
DECLARE @marker_scope_create_peer_timestamp BIGINT
DECLARE @marker_scope_create_peer_key INT
