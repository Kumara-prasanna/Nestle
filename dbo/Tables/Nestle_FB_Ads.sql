CREATE TABLE [dbo].[Nestle_FB_Ads] (
...
GO
CREATE NONCLUSTERED INDEX [ix_Nestle_FB_Ads_dt_filename]
    ON [dbo].[Nestle_FB_Ads]([dt_filename] ASC);


GO
CREATE NONCLUSTERED INDEX [idx_date]
    ON [dbo].[Nestle_FB_Ads]([date_start] ASC);


GO
CREATE NONCLUSTERED INDEX [idx_campaign]
    ON [dbo].[Nestle_FB_Ads]([campaign_name] ASC);
