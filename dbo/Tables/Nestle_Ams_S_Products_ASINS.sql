CREATE TABLE [dbo].[Nestle_Ams_S_Products_ASINS] (
...
GO
CREATE NONCLUSTERED INDEX [ix_Nestle_Ams_S_Products_ASINS_dt_filename]
    ON [dbo].[Nestle_Ams_S_Products_ASINS]([dt_filename] ASC);
