CREATE TABLE [dbo].[dbo.Nestle_Search_GoogleAds] (
...
GO
CREATE NONCLUSTERED INDEX [ix_Nestle_Google_Ads_V2_dt_filename]
    ON [dbo].[dbo.Nestle_Search_GoogleAds]([dt_filename] ASC);
