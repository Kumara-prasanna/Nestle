CREATE TABLE [dbo].[Netsle_Google_Ads_KW_V21] (
...
GO
CREATE NONCLUSTERED INDEX [ix_Netsle_Google_Ads_KW_V21_dt_filename]
    ON [dbo].[Netsle_Google_Ads_KW_V21]([dt_filename] ASC);
