...
CREATE VIEW [dbo].[Nestle_Search_Google_NewConv_View]
AS
...
(
select T1.*, 
T2.Country, T2.[Master Brand], T2.[Range Brand], T2.[Language], T2.[Search Engine], T2.[Targeting Type], T2.[Campaign Match Type], T2.[Audience Detail], T2.[Campaign Objective], T2.[Sub-Segment], T2.[Local Segment], T2.[Campaign Free Field], T2.[Campaign ID],
T2.[Decoded Campaign Match Type], T2.[Decoded Audience Detail], T2.[Decoded Sub-Segment/Category], T2.[Decoded Master Brand], T2.[Decoded Range Brand], T2.[Decoded Campaign Objective]
from GoogleAds_Keywords_Table T1 LEFT JOIN CampaignObjective_Table T2
ON T1.campaign = T2.campaign
)
--select * from SEM_New_View
,
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "Nestle_Google_Ads (dbo)"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 383
            ...
            TopColumn = 0
         End
         Begin Table = "Nestle_Google_Ads_KW (dbo)"
            Begin Extent = 
               Top = 6
               Left = 333
               Bottom = 379
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Nestle_Search_Google_NewConv_View';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Nestle_Search_Google_NewConv_View';
