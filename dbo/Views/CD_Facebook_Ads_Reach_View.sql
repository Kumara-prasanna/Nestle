...
CREATE VIEW [dbo].[CD_Facebook_Ads_Reach_View] 

AS
WITH Facebook_Reach_Table
AS (
	(
	SELECT
	    [account_name] AS 'Account',
	    [date_start] AS 'Start Date',
 		[date_stop] AS 'End Date',
        [campaign_name] AS 'Campaign',
        [reach] AS 'Reach',
		[impressions] AS 'Impressions',
		inline_link_clicks AS 'Link Clicks',
        [frequency] AS 'Frequency',
        [spend] AS 'Spend',
		[dt_updated] AS 'Update date',
		'Weekly' AS [Table],  --FY20_Trojan_Q2_CW9_TRO_004_EN_R/F_FB-IG_Sext_Us_Reach_May 22 - May 31 -- FY20_Anusol_Q4_CW9_ANU_001_FR_Auction_FB-IG_Thanksgiving_Brand Awareness_Oct1-Nov4
