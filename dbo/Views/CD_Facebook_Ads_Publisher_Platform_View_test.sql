...
CREATE VIEW [dbo].[CD_Facebook_Ads_Publisher_Platform_View_test] 
...
AS (
	...
	SELECT 
		...
		platform_position_pp AS 'Platform Position',
		publisher_platform_pp AS 'Published Platform',    --FY20_Trojan_Q2_CW9_TRO_004_EN_R/F_FB-IG_Sext_Us_Reach_May 22 - May 31 -- FY20_Anusol_Q4_CW9_ANU_001_FR_Auction_FB-IG_Thanksgiving_Brand Awareness_Oct1-Nov4
