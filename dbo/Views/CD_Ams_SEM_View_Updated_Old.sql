...
CREATE VIEW [dbo].[CD_Ams_SEM_View_Updated_Old]
AS
...
--setting up column language based on  pattern matching
		 CASE
         WHEN [Campaign Type] LIKE '%headlineSearch%'  THEN 'Sponsored Brands'
		 WHEN  [Campaign Type] LIKE '%sponsoredProducts%'  THEN 'Sponsored Products'
		 ELSE 'Other'
			END AS [Ad Type],
