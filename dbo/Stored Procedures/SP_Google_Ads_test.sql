...
/****** Object:  View [dbo].[Test_SP_Nestle_Search_Google_NewConv_View_KP]    Script Date: 11/25/2020 1:44:58 PM ******/
CREATE procedure [dbo].[SP_Google_Ads_test]
as
Begin

--ALTER VIEW [dbo].[Test_SP_Nestle_Search_Google_NewConv_View_KP]
--AS
