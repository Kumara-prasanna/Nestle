...
create procedure [dbo].[Nestle_Social_Twitter_SP] 
AS
Begin
	...
	(
	SELECT *
	FROM Twitter_Brand_Filter_Table AS a
...
SELECT  a.*, b.CPM
FROM Twitter_view  AS a JOIN [dbo].[Nestle_Social_Twitter_KPI] as b ON a.Brand = b.Brand
